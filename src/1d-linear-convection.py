...
def linearconvection_animation(nx):
    dx = 2 / (nx-1)
    nt = 20
    sigma = 0.5
    c = 1
    ...
    ''' # Wyżej napisane to samo ale lepiej
    for i in range(nx):
        if i > 5 and i < 10:
            u[i] = 2
        else:
    ...
    animation.save('1d-linear-convection.gif', writer='pillow', fps=10)
    pyplot.show()
    
linearconvection_animation(81)    